...
__ATTRIBUTES intmax_t strtoimax(const char *_Restrict, char **_Restrict, int);
__ATTRIBUTES uintmax_t strtoumax(const char *_Restrict, char **_Restrict, int);
__ATTRIBUTES intmax_t wcstoimax(const _Wchart *_Restrict, _Wchart **_Restrict, 
                                int);
__ATTRIBUTES uintmax_t wcstoumax(const _Wchart *_Restrict, _Wchart **_Restrict,
                                 int);
_END_C_LIB_DECL
