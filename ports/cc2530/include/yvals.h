...
#if __TAABI_PORTABILITY_INTERNAL_LEVEL && !_DLIB_SUPPORT_FOR_TAABI
  #error "__TAABI_PORTABILITY_LEVEL != 0 needs a library built with _DLIB_SUPPORT_FOR_TAABI turned on"
#endif
...
#if _DLIB_SUPPORT_FOR_TAABI && !_DLIB_MBSTATET_USES_UNSIGNED_LONG
  typedef struct
